...
AMP_ARENACharacter::AMP_ARENACharacter()
{
...
void AMP_ARENACharacter::NotifyControllerChanged()
{
...
void AMP_ARENACharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMP_ARENACharacter::Move);
...
void AMP_ARENACharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMP_ARENACharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
